...
class CausalConv1d(nn.Conv1d):
    ...
    def forward(self, x: th.Tensor) -> th.Tensor:
        return super().forward(th_f.pad(x, ((self.kernel_size[0] - 1) * self.dilation[0], 0)))
...
class BrainActivityLiquidRecurrent(LiquidRecurrent):
    ...
    def _process_input(self, i: th.Tensor) -> th.Tensor:
        ...
        return th.cat([encoded_input, self.__cls_token.repeat(encoded_input.size(0), 1, 1)], dim=1)
